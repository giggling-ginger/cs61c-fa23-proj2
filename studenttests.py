...
class TestAbsLoss(unittest.TestCase):
    def test_simple(
        self,
        result_array=[0, 4, 2, 2, 4, 0, 6, 2, 8],
        fail="",
        code=0,
    ):
        ...
        # t.check_array_pointer("a3", result_array) 
        # a3 is not saved, shouldn't use a3 after calling func
    ...
    def test_abs_loss_length_invalid_error(self):
        # load the test for abs_loss.s
        t = AssemblyTest(self, "../coverage-src/abs_loss.s")
        # set a2 to the length of the array
        t.input_scalar("a2", 0)
...
class TestSquaredLoss(unittest.TestCase):
    def test_simple(
        self,
        result_array=[0, 16, 4, 4, 16, 0, 36, 4, 64],
        fail="",
        code=0,
    ):
    ...
    def test_squared_loss_length_invalid_error(self):
        # load the test for abs_loss.s
        t = AssemblyTest(self, "../coverage-src/squared_loss.s")
        # set a2 to the length of the array
        t.input_scalar("a2", 0)
...
class TestZeroOneLoss(unittest.TestCase):
    def test_simple(
        self,
        result_array=[1, 0, 0, 0, 0, 1, 0, 0, 0],
        fail="",
        code=0,
    ):
    ...
    # Add other test cases if neccesary
    def test_zero_one_loss_length_invalid_error(self):
        # load the test for abs_loss.s
        t = AssemblyTest(self, "../coverage-src/zero_one_loss.s")
        # set a2 to the length of the array
        t.input_scalar("a2", 0)
...
class TestInitializeZero(unittest.TestCase):
    ...
    def test_initialize_zero_length_invalid_error_1(self):
        t = AssemblyTest(self, "../coverage-src/initialize_zero.s")
    ...
    def test_initialize_zero_length_invalid_error_2(self):
        t = AssemblyTest(self, "../coverage-src/initialize_zero.s")
